...
dependencies {
    ...
    implementation("androidx.lifecycle:lifecycle-runtime-ktx:2.6.2") // Existing
    ...
    // OkHttp (Retrofit's default HTTP client, good to have explicit control if needed)
    implementation("com.squareup.okhttp3:okhttp:4.11.0")
    implementation("com.squareup.okhttp3:logging-interceptor:4.11.0") // For logging requests/responses (optional but helpful)
}
